...
foreach($select_kabkota as $kabkota){
    echo("
        <tr>
                  ...
                  <td><center><input class=\"my-checkbox\" data-toggle='tooltip' data-placement='top' data-original-title=\"PU\" type=\"checkbox\" name=\"banjirkab".$kabkota['kode_kab']."[0]\" value=\"1\" ></center></td>
